...
#define STRING_CONFIG_H_AUTHOR "(Jan Kos)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FFF Printer" //*
...
#define HEATER_1_MAXTEMP 340 //*
#define HEATER_2_MAXTEMP 340 //*
#define HEATER_3_MAXTEMP 340 //*
#define HEATER_4_MAXTEMP 340 //*
#define HEATER_5_MAXTEMP 340 //*
#define HEATER_6_MAXTEMP 340 //*
#define HEATER_7_MAXTEMP 340 //*
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  225.00 //*
    #define DEFAULT_Ki   42.50 //*
    #define DEFAULT_Kd  290.00 //*
  #endif
#else
 ...
 */
  ...
  #define MPC_HEATER_POWER { 80.0f }                  // (W) Heat cartridge powers.

  #define MPC_INCLUDE_FAN                             // Model the fan speed?

  // Measured physical constants from M306
  #define MPC_BLOCK_HEAT_CAPACITY { 31.28f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1357f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.2248f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.2546f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED //*
  ...
  #define DEFAULT_bedKp 180.00 //*
  #define DEFAULT_bedKi  33.50 //*
  #define DEFAULT_bedKd 650.00 //*
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 25, 75 } //*

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 25, 100 } //* ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 10000, 10000, 400, 20000 } //* ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 25, 25, 1, 15 } //* ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.500 } //*
...
#define LCD_BED_TRAMMING //*
  ...
  #define BED_TRAMMING_INSET_LFRB { 12, 45, 12, 45 } //* (mm) Left, Front, Right, Back insets
...
//
#define PREHEAT_1_LABEL       "200-60"  //*
#define PREHEAT_1_TEMP_HOTEND 200       //*
#define PREHEAT_1_TEMP_BED     60       //*
#define PREHEAT_1_TEMP_CHAMBER  0
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "240-80"  //*
...
#define NEOPIXEL_LED //*
  ...
  #define NEOPIXEL_PIXELS              68 //* Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  ...
  #define NEOPIXEL_BKGD_INDEX_FIRST   18 //* Index of the first background LED
  #define NEOPIXEL_BKGD_INDEX_LAST    38 //* Index of the last background LED
