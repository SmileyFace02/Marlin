 ...
 */
#define CONFIGURATION_ADV_H_VERSION 02010300 //* MODIFIED ENDS WITH /*
...
#define CASE_LIGHT_ENABLE //*
  ...
  #define CASE_LIGHT_PIN PE7                  //* Override the default pin if needed
...
#define FT_MOTION
  ...
  #define FTM_DEFAULT_MODE        ftMotionMode_ZVDDD // Default mode of fixed time control. (Enums in ft_types.h)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 75*60, 75*60, 10*60, 5*60 } //* (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define FWRETRACT //*
  ...
  #define RETRACT_RECOVER_LENGTH        1   //* (mm) Default additional recover length (added to retract length on recover)
...
#define ADVANCED_PAUSE_FEATURE //*
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL         4  //* (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT         1500  //* (seconds) Time limit before the nozzle is turned off for safety.
 ...
 */
  ...
  #define I_HYBRID_THRESHOLD      10  // [linear=mm/s, rotational=°/s]
  #define J_HYBRID_THRESHOLD      10  // [linear=mm/s, rotational=°/s]
  #define K_HYBRID_THRESHOLD      10  // [linear=mm/s, rotational=°/s]
  #define U_HYBRID_THRESHOLD      10  // [mm/s]
  #define V_HYBRID_THRESHOLD      10
  #define W_HYBRID_THRESHOLD      10
  ...
  #define E6_HYBRID_THRESHOLD     25
  #define E7_HYBRID_THRESHOLD     25
...
//#define NO_VOLUMETRICS
  ...
  //#define VOLUMETRIC_EXTRUDER_LIMIT
    ...
    #define VOLUMETRIC_EXTRUDER_LIMIT_MAX    100        //* (mm^3/sec)
  #endif
#endif
